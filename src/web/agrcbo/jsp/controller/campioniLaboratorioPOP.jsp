...
<%
  ...
  if (ricercaBreve)
  {
    aut.ricercaElencoCampioni(Autenticazione.RICERCA_CAMPIONI_LABORATORIO,annoCampione,numeroCampioneDa,idRichiestaDa,
                              tipoMateriale);
  }
  else
  {
    aut.ricercaElencoCampioni(Autenticazione.RICERCA_CAMPIONI_LABORATORIO,true,annoCampione,numeroCampioneDa,numeroCampioneA,
                              ...
                              statoPagamento,organizzazione,labAnalisi,null,null,true,false,iuv);
  }
...
<html>
<head></head>
<body onLoad="window.opener.location.href='../../jsp/view/campioniLaboratorio.jsp';window.opener.focus();window.close();"></body>
</html>
<%
  }
%>
