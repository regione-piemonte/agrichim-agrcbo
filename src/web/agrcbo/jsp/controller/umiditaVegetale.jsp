...
<%
  ...
  if ("delete".equals(azione))
  {
    ...
    Utili.forwardConParametri(request, response, "/jsp/view/umiditaVegetale.jsp");
    return;
  }
  else
  {
    ...
    */
    if (errore!=null)
    {
      Utili.forwardConParametri(request, response, "/jsp/view/umiditaVegetale.jsp?modifica=no&errore="+errore);
      return;
    }
    if ("update".equals(azione) || umiditaCampione.select()) umiditaCampione.update();
    else umiditaCampione.insert();
    Utili.forwardConParametri(request, response, "/jsp/view/umiditaVegetale.jsp?modifica=si");
  }
%>
