...
public class MacroMicroElemIndFrutta  extends ModelloInsEsitoAnalisi
{
   ...
   * MACRO_MICRO_ELEM_IND_FRUTTA. Alcuni dati sono quelli di input inseriti
  ...
  public void insert() throws Exception, SQLException
  {
    ...
    try
    {
      ...
      query = new StringBuffer("INSERT INTO MACRO_MICRO_ELEM_IND_FRUTTA(");
      query.append("ID_RICHIESTA,PESO_CAMPIONE, VOLUME_PRIMA_DILUIZIONE,");
      query.append("SECONDA_DILUIZIONE_CA, CALCIO_PPM, LETTURA_CA_PPM, ");
      query.append("CALCIO, SECONDA_DILUIZIONE_MG, MAGNESIO_PPM, LETTURA_MG_PPM, ");
      query.append("MAGNESIO, SECONDA_DILUIZIONE_K, POTASSIO_PPM, ");
      query.append("LETTURA_K_PPM, POTASSIO, AZOTO, ");
    ...
    {
      this.getAut().setQuery("insert della classe MacroMicroElemIndFrutta");
      this.getAut().setContenutoQuery(query.toString());
      throw (ex);
    }
    catch(Exception e)
  ...
  public void update() throws Exception, SQLException
  {
    ...
    try
    {
      conn=getConnection();
      Statement stmt = conn.createStatement();
      query = new StringBuffer("UPDATE MACRO_MICRO_ELEM_IND_FRUTTA ");
      query.append("SET PESO_CAMPIONE = ").append(getPesoCampione());
      query.append(",VOLUME_PRIMA_DILUIZIONE = ").append(getVolumePrimaDiluizione());
      query.append(",SECONDA_DILUIZIONE_CA = ").append(getSecondaDiluizioneCa ());
      ...
      query.append(",SECONDA_DILUIZIONE_MG = ").append(getSecondaDiluizioneMg ());
      ...
      query.append(",SECONDA_DILUIZIONE_K = ").append(getSecondaDiluizioneK ());
    ...
    {
      this.getAut().setQuery("update della classe MacroMicroElemIndFrutta");
      this.getAut().setContenutoQuery(query.toString());
      throw (ex);
    }
    catch(Exception e)
  ...
  public void delete() throws Exception, SQLException
  {
    ...
    try
    {
      conn=getConnection();
      Statement stmt = conn.createStatement();
      query = new StringBuffer("DELETE FROM MACRO_MICRO_ELEM_IND_FRUTTA ");
    ...
    {
      this.getAut().setQuery("delete della classe MacroMicroElemIndFrutta");
      this.getAut().setContenutoQuery(query.toString());
      throw (ex);
    }
    catch(Exception e)
  ...
  public Double getCalcioPpmCalcoli()
  {
    ...
    try
    {
      ...
      double volumePrimaDiluizione=Double.parseDouble(getVolumePrimaDiluizione());
      double secondaDiluizioneCa=Double.parseDouble(getSecondaDiluizioneCa());
      double letturaCaPpm=Double.parseDouble(getLetturaCaPpm());
      if (pesoCampione>0 && volumePrimaDiluizione>0 && secondaDiluizioneCa>0 && letturaCaPpm>0)
        calcioPpm= (volumePrimaDiluizione*secondaDiluizioneCa*letturaCaPpm)/pesoCampione;
    }
    catch(Exception num)
    {
      calcioPpm=0;
  ...
  public Double getMagnesioPpmCalcoli()
  {
    ...
    try
    {
      double pesoCampione=Double.parseDouble(getPesoCampione());
      double volumePrimaDiluizione=Double.parseDouble(getVolumePrimaDiluizione());
      double secondaDiluizioneMg=Double.parseDouble(getSecondaDiluizioneMg());
      double letturaMgPpm=Double.parseDouble(getLetturaMgPpm());
      if (pesoCampione>0 && volumePrimaDiluizione>0 && secondaDiluizioneMg>0 && letturaMgPpm>0)
        magnesioPpm= (volumePrimaDiluizione*secondaDiluizioneMg*letturaMgPpm)/pesoCampione;
    }
    catch(Exception num)
    {
      magnesioPpm=0;
  ...
  public Double getPotassioPpmCalcoli()
  {
    ...
    try
    {
      double pesoCampione=Double.parseDouble(getPesoCampione());
      double volumePrimaDiluizione=Double.parseDouble(getVolumePrimaDiluizione());
      double secondaDiluizioneK=Double.parseDouble(getSecondaDiluizioneK());
      double letturaKPpm=Double.parseDouble(getLetturaKPpm());
      if (pesoCampione>0 && volumePrimaDiluizione>0 && secondaDiluizioneK>0 && letturaKPpm>0)
        potassioPpm= (volumePrimaDiluizione*secondaDiluizioneK*letturaKPpm)/pesoCampione;
    }
    catch(Exception num)
    {
      potassioPpm=0;
  ...
  public String ControllaDati(boolean calcio,boolean magnesio,
                              boolean potassio,boolean azoto,boolean fosforo)
  {
    StringBuffer errore=new StringBuffer("");
    if (!Utili.isDouble(getPesoCampione(),0.001,999999.999,3))
      errore.append(";1");
    if (!Utili.isDouble(getVolumePrimaDiluizione(),0.001,999999.999,3))
      errore.append(";2");

    if (calcio)
    {
      if (!Utili.isDouble(getSecondaDiluizioneCa(),0.001,999999.999,3))
        errore.append(";3");
    ...
    if (magnesio)
    {
      if (!Utili.isDouble(getSecondaDiluizioneMg(),0.001,999999.999,3))
        errore.append(";5");
    ...
    if (potassio)
    {
      if (!Utili.isDouble(getSecondaDiluizioneK(),0.001,999999.999,3))
        errore.append(";7");
