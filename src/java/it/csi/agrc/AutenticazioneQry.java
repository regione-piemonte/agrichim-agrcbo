...
public class AutenticazioneQry extends BeanDAO implements Serializable
{
                              ...
                              )
  {
    ...
    */
    ...
    query.append("PAGATA,ANNULLATA,PARTITA_IVA_O_CF,RAGIONE_SOCIALE, numero_campione, anno_E, (numero_campione || '/' || ANNO_E) as EE ");
                                    ...
                                    String tipoMateriale)
  {
    this.ricercaElencoCampioni(ricerca,true,anno,numCampione,null,idRichiesta,
                               null,null,null,null,null,null,null,null,null,tipoMateriale,
                                    ...
                                    boolean filtroBreve)
  {
    ...
    if (filtri) filtro=impostaCriteriRicerca(ricerca,anno,numCampioneDa,numCampioneA,
                                      idRichiestaDa,idRichiestaA,dataDa,dataA,
    ...
    */
    ...
    {
    	queryCount.append(", DATI_FATTURA DF ");    	
    }
    /* CONCLUSIONE CLAUSOLA FROM - FINE */

    queryCount.append("WHERE EC.CODICE_MATERIALE= M.CODICE_MATERIALE ");
    ...
    if (ricerca == RICERCA_REFERTI_EMESSI || analisiFattura!=null)
    {
        queryCount.append("AND EC.ID_RICHIESTA=DF.ID_RICHIESTA ");
    }
                                       ...
                                       boolean filtroBreve)
  {
    ...
    if (organizzazione!=null && !"-1".equals(organizzazione))
    {
      ...
      filtro.append(" AND (A.ID_ANAGRAFICA=EC.ANAGRAFICA_TECNICO ") ;
      filtro.append(" OR A.ID_ANAGRAFICA=EC.ANAGRAFICA_UTENTE) ") ;
    }
    if (labAnalisi!=null)
    {
