...
public class PdfRisultatoAnalisiFOG extends PdfServletAgrc
{
  private static final long serialVersionUID = 6946580041323893408L;
  ...
  public PdfRisultatoAnalisiFOG()
  {
    this.setOutputName("risultatoAnalisiFOG.pdf");
      ...
      throws Exception
  {
    ...
    MacroMicroElemIndFoglie macroMicroElemIndFoglie= new MacroMicroElemIndFoglie();
    macroMicroElemIndFoglie.setDataSource(dataSource);
    macroMicroElemIndFoglie.setAut(aut);
    macroMicroElemIndFoglie.setIdRichiesta(lIdRichiesta);
    boolean bMacroMicroElemIndFoglie=macroMicroElemIndFoglie.select();
    ...
    //CuneoLogger.debug(this,"Passo di qua: PdfRisultatoAnalisiFOG.java");
    ...
    */
    ...
    if (bMacroMicroElemIndFoglie)
    {
      if (!"".equals(macroMicroElemIndFoglie.getAzotoPpmPDF())) numRigheTblAnalisi++;
      if (!"".equals(macroMicroElemIndFoglie.getAzotoPDF())) numRigheTblAnalisi++;
      if (!"".equals(macroMicroElemIndFoglie.getFosforoPpmPDF())) numRigheTblAnalisi++;
      if (!"".equals(macroMicroElemIndFoglie.getFosforoPDF())) numRigheTblAnalisi++;
      if (!"".equals(macroMicroElemIndFoglie.getCalcioPpmPDF())) numRigheTblAnalisi++;
      if (!"".equals(macroMicroElemIndFoglie.getCalcioPDF())) numRigheTblAnalisi++;
      if (!"".equals(macroMicroElemIndFoglie.getMagnesioPpmPDF())) numRigheTblAnalisi++;
      if (!"".equals(macroMicroElemIndFoglie.getMagnesioPDF())) numRigheTblAnalisi++;
      if (!"".equals(macroMicroElemIndFoglie.getPotassioPpmPDF())) numRigheTblAnalisi++;
      if (!"".equals(macroMicroElemIndFoglie.getPotassioPDF())) numRigheTblAnalisi++;
      if (!"".equals(macroMicroElemIndFoglie.getKCaPDF())) numRigheTblAnalisi++;
      if (!"".equals(macroMicroElemIndFoglie.getFerroPpmPDF())) numRigheTblAnalisi++;
      if (!"".equals(macroMicroElemIndFoglie.getManganesePpmPDF())) numRigheTblAnalisi++;
      if (!"".equals(macroMicroElemIndFoglie.getRamePpmPDF())) numRigheTblAnalisi++;
      if (!"".equals(macroMicroElemIndFoglie.getZincoPpmPDF())) numRigheTblAnalisi++;
      if (!"".equals(macroMicroElemIndFoglie.getBoroPpmPDF())) numRigheTblAnalisi++;
    }
    ...
    if (bMacroMicroElemIndFoglie)
    {
      if (!"".equals(macroMicroElemIndFoglie.getAzotoPpmPDF()))
      {
        tblAnalisi.setFont (rigaCorTblAnalisi,1,new Font("SansSerif",Font.BOLD,8));
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"Azoto");
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getAzotoPpmPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,4,"ppm");
        tblAnalisi.setObject(rigaCorTblAnalisi,6,"interno");
        rigaCorTblAnalisi++;
      }
      if (!"".equals(macroMicroElemIndFoglie.getAzotoPDF()))
      {
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"Azoto");
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getAzotoPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,4,"%");
        rigaCorTblAnalisi++;
      }
      if (!"".equals(macroMicroElemIndFoglie.getFosforoPpmPDF()))
      {
        tblAnalisi.setFont (rigaCorTblAnalisi,1,new Font("SansSerif",Font.BOLD,8));
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"Fosforo");
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getFosforoPpmPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,4,"ppm");
        tblAnalisi.setObject(rigaCorTblAnalisi,6,"interno");
        rigaCorTblAnalisi++;
      }
      if (!"".equals(macroMicroElemIndFoglie.getFosforoPDF()))
      {
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"Fosforo");
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getFosforoPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,4,"%");
        rigaCorTblAnalisi++;
      }
      if (!"".equals(macroMicroElemIndFoglie.getCalcioPpmPDF()))
      {
        tblAnalisi.setFont (rigaCorTblAnalisi,1,new Font("SansSerif",Font.BOLD,8));
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"Calcio");
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getCalcioPpmPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,4,"ppm");
        tblAnalisi.setObject(rigaCorTblAnalisi,6,"interno");
        rigaCorTblAnalisi++;
      }
      if (!"".equals(macroMicroElemIndFoglie.getCalcioPDF()))
      {
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"Calcio");
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getCalcioPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,4,"%");
        tblAnalisi.setObject(rigaCorTblAnalisi,6,"calcolato");
        rigaCorTblAnalisi++;
      }
      if (!"".equals(macroMicroElemIndFoglie.getMagnesioPpmPDF()))
      {
        tblAnalisi.setFont (rigaCorTblAnalisi,1,new Font("SansSerif",Font.BOLD,8));
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"Magnesio");
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getMagnesioPpmPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,4,"ppm");
        tblAnalisi.setObject(rigaCorTblAnalisi,6,"interno");
        rigaCorTblAnalisi++;
      }
      if (!"".equals(macroMicroElemIndFoglie.getMagnesioPDF()))
      {
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"Magnesio");
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getMagnesioPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,4,"%");
        tblAnalisi.setObject(rigaCorTblAnalisi,6,"calcolato");
        rigaCorTblAnalisi++;
      }
      if (!"".equals(macroMicroElemIndFoglie.getPotassioPpmPDF()))
      {
        tblAnalisi.setFont (rigaCorTblAnalisi,1,new Font("SansSerif",Font.BOLD,8));
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"Potassio");
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getPotassioPpmPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,4,"ppm");
        tblAnalisi.setObject(rigaCorTblAnalisi,6,"interno");
        rigaCorTblAnalisi++;
      }
      if (!"".equals(macroMicroElemIndFoglie.getPotassioPDF()))
      {
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"Potassio");
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getPotassioPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,4,"%");
        tblAnalisi.setObject(rigaCorTblAnalisi,6,"calcolato");
        rigaCorTblAnalisi++;
      }
      if (!"".equals(macroMicroElemIndFoglie.getKCaPDF()))
      {
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"K/Ca");
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getKCaPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,6,"calcolato");
        rigaCorTblAnalisi++;
      }
      if (!"".equals(macroMicroElemIndFoglie.getFerroPpmPDF()))
      {
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"Ferro");
        tblAnalisi.setFont (rigaCorTblAnalisi,1,new Font("SansSerif",Font.BOLD,8));
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getFerroPpmPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,4,"ppm");
        tblAnalisi.setObject(rigaCorTblAnalisi,6,"interno");
        rigaCorTblAnalisi++;
      }
      if (!"".equals(macroMicroElemIndFoglie.getManganesePpmPDF()))
      {
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"Manganese");
        tblAnalisi.setFont (rigaCorTblAnalisi,1,new Font("SansSerif",Font.BOLD,8));
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getManganesePpmPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,4,"ppm");
        tblAnalisi.setObject(rigaCorTblAnalisi,6,"interno");
        rigaCorTblAnalisi++;
      }
      if (!"".equals(macroMicroElemIndFoglie.getRamePpmPDF()))
      {
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"Rame");
        tblAnalisi.setFont (rigaCorTblAnalisi,1,new Font("SansSerif",Font.BOLD,8));
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getRamePpmPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,4,"ppm");
        tblAnalisi.setObject(rigaCorTblAnalisi,6,"interno");
        rigaCorTblAnalisi++;
      }
      if (!"".equals(macroMicroElemIndFoglie.getZincoPpmPDF()))
      {
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"Zinco");
        tblAnalisi.setFont (rigaCorTblAnalisi,1,new Font("SansSerif",Font.BOLD,8));
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getZincoPpmPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,4,"ppm");
        tblAnalisi.setObject(rigaCorTblAnalisi,6,"interno");
        rigaCorTblAnalisi++;
      }
      if (!"".equals(macroMicroElemIndFoglie.getBoroPpmPDF()))
      {
        tblAnalisi.setObject(rigaCorTblAnalisi,1,"Boro");
        tblAnalisi.setFont (rigaCorTblAnalisi,1,new Font("SansSerif",Font.BOLD,8));
        tblAnalisi.setObject(rigaCorTblAnalisi,2,macroMicroElemIndFoglie.getBoroPpmPDF()+" ");
        tblAnalisi.setObject(rigaCorTblAnalisi,4,"ppm");
        tblAnalisi.setObject(rigaCorTblAnalisi,6,"interno");
        rigaCorTblAnalisi++;
      }
